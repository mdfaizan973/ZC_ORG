  ...
  const getStatusInfo = (status) => {
    switch (status) {
      ...
      case "Work in progress":
        return {
          icon: <FaSpinner className="text-green-500 animate-spin" />,
          color: "text-green-500 bg-green-50 border-green-200",
        };
      case "In review":
        return {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          >
                            {statusInfo.icon}
                            <span className="ml-1">{bug.is_bug_fixed}</span>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          <div className="flex flex-col">
                            <span>{formatDate(bug.bug_report_date)}</span>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex space-x-2">
                    ...
                    >
                      ...
                      <span className="ml-1">{selectedBug.is_bug_fixed}</span>
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
                    ...
                    <p className="text-gray-700 font-mono">{selectedBug._id}</p>
                  </div>
                  <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
                    <h4 className="text-xs uppercase text-gray-500 font-semibold mb-1">
                      User ID
